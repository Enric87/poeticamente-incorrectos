...
const MOVE_SPEED = 0.11; // % del ancho de pantalla por frame
  ...
  return (
    <div className="relative w-full h-full flex flex-col">
      ...
      >
        ...
        {/* Adri controlable */}
        <div
          className="absolute bottom-[20%] w-24 sm:w-32"
        ...
        <div className="absolute bottom-3 left-4 font-pixel text-[8px] sm:text-[10px] text-white bg-[var(--pi-brown-dark)] px-2 py-1 border border-white/70">
        ...
        <button
          ...
          className="absolute bottom-3 right-4 font-pixel text-[8px] sm:text-[10px] text-white bg-[var(--pi-brown-dark)] px-2 py-1 border border-white/70 hover:text-[var(--pi-orange)] hover:border-[var(--pi-orange)]"
        >
          ← VOLVER
        </button>
      </div>
